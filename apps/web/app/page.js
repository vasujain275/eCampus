...
function Page() {
    return (<main className={page_module_css_1.default.main}>
      <div className={page_module_css_1.default.description}>
        <p>
          examples/basic&nbsp;
          <code className={page_module_css_1.default.code}>web</code>
        </p>
        <div>
        ...
        <div className={page_module_css_1.default.heroContent}>
          <div className={page_module_css_1.default.logos}>
            <div className={page_module_css_1.default.circles}>
              <image_1.default alt="Turborepo" height={614} src="circles.svg" width={614}/>
            </div>
            ...
            <div className={page_module_css_1.default.logo}>
              <image_1.default alt="" height={120} priority src="turborepo.svg" width={120}/>
            </div>
          </div>
      ...
      <div className={page_module_css_1.default.grid}>
        {LINKS.map(function (_a) {
            var title = _a.title, href = _a.href, description = _a.description;
            return (<ui_1.Card className={page_module_css_1.default.card} href={href} key={title} title={title}>
            {description}
          </ui_1.Card>);
        })}
      </div>
